  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 sm:gap-3">
        <div className="w-2.5 h-2.5 sm:w-3 sm:h-3 bg-[#E91E63] rounded-full animate-pulse flex-shrink-0" />
                  ...
                  <div className="stepper-step flex items-center gap-2 min-w-[80px] sm:min-w-[100px]">
                    <div
                      className={`w-7 h-7 sm:w-8 sm:h-8 rounded-full flex items-center justify-center text-xs font-bold transition-all duration-300 flex-shrink-0 ${
                        step.completed
                          ? "bg-gradient-to-r from-[#E91E63] to-[#EC407A] text-white shadow-lg"
                    ...
                    <span
                      className={`font-medium transition-colors duration-300 text-xs sm:text-sm whitespace-nowrap ${
                        step.completed ? "text-[#E91E63]" : "text-gray-500"
                      }`}
                    >
        ...
        <AnimatePresence mode="wait">
          ...
          {currentStep === "landing" && (
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="min-h-screen bg-gradient-to-br from-[#1A1A2E] to-[#E91E63] relative overflow-hidden"
            >
              {/* Background with DeepCheck AI logos */}
              <div className="absolute inset-0 opacity-5 sm:opacity-10">
                {[...Array(8)].map((_, index) => (
                  ...
                  >
                    <img 
                      src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/WhatsApp%20Image%202025-07-25%20at%2000.06.01-HlLJW3PBzLGO5VgYykkYeOOA3yA4LK.jpeg" 
                      alt="DeepCheck AI Background" 
              ...
              <div className="relative z-10 container mx-auto px-4 py-8 sm:py-12">
                ...
                <div className="text-center mb-12 sm:mb-16">
                  <motion.div
                    ...
                    className="inline-flex items-center justify-center w-20 h-20 sm:w-24 sm:h-24 rounded-2xl mb-6 sm:mb-8 shadow-2xl overflow-hidden"
                  >
                    <img 
                      src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/WhatsApp%20Image%202025-07-25%20at%2000.06.01%20%281%29-StfEy4Md5yrJy8hbDh7HiHxfkdd9eY.jpeg" 
                      alt="DeepCheck AI Logo" 
                  ...
                  >
                    ...
                    <br />
                    <span className="text-[#EC407A] text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-extrabold text-amber-500">
                  ...
                  <motion.div
                    ...
                    className="inline-flex items-center gap-2 bg-[#E91E63]/20 text-[#EC407A] px-4 sm:px-6 py-2 sm:py-3 rounded-full text-sm mt-4 border border-[#E91E63]/30"
                  >
                    <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
                    <span className="font-medium text-white">Advanced Detection System - Updated  2025</span>
                  </motion.div>
                </div>
                ...
                >
                  <div className="flex items-center gap-3 sm:gap-4 bg-white/10 backdrop-blur-sm text-white px-4 sm:px-6 py-3 sm:py-4 rounded-2xl border border-white/20 hover:bg-white/15 transition-all duration-300">
                    <Activity className="w-5 h-5 sm:w-6 sm:h-6 flex-shrink-0 text-[#EC407A] text-emerald-400" />
                    <span className="font-semibold text-sm sm:text-base">
                      ✅ See their last login (even when they say they're 'done' with apps)
                    </span>
                  </div>
                  <div className="flex items-center gap-3 sm:gap-4 bg-white/10 backdrop-blur-sm text-white px-4 sm:px-6 py-3 sm:py-4 rounded-2xl border border-white/20 hover:bg-white/15 transition-all duration-300">
                    <MapPin className="w-5 h-5 sm:w-6 sm:h-6 flex-shrink-0 text-[#EC407A] text-emerald-400" />
                    <span className="font-semibold text-sm sm:text-base">
                      ✅ Discover where they're really swiping from
                    </span>
                  </div>
                  <div className="flex items-center gap-3 sm:gap-4 bg-white/10 backdrop-blur-sm text-white px-4 sm:px-6 py-3 sm:py-4 rounded-2xl border border-white/20 hover:bg-white/15 transition-all duration-300">
                    <Eye className="w-5 h-5 sm:w-6 sm:h-6 flex-shrink-0 text-[#EC407A] text-emerald-400" />
                    <span className="font-semibold text-sm sm:text-base">
                      ✅ Access the conversations they don't want you to see
                    </span>
                  </div>
                  <div className="flex items-center gap-3 sm:gap-4 bg-white/10 backdrop-blur-sm text-white px-4 sm:px-6 py-3 sm:py-4 rounded-2xl border border-white/20 hover:bg-white/15 transition-all duration-300">
                    <Shield className="w-5 h-5 sm:w-6 sm:h-6 flex-shrink-0 text-[#EC407A] text-emerald-400" />
                    <span className="font-semibold text-sm sm:text-base">
              ...
              <div className="bg-white py-12 sm:py-16">
                <div className="container mx-auto px-4">
                  <div className="text-center mb-8 sm:mb-12">
                    ...
                    <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#E91E63] to-[#EC407A] mb-6">
                  ...
                  <div className="grid grid-cols-2 gap-4 sm:gap-6 md:gap-8 max-w-4xl mx-auto mb-8 sm:mb-12">
                    <div className="text-center p-4 sm:p-6 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300">
                      <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-r from-[#E91E63]/20 to-[#EC407A]/20 rounded-2xl flex items-center justify-center mx-auto mb-3 sm:mb-4">
                        <Heart className="w-6 h-6 sm:w-8 sm:h-8 text-[#E91E63]" />
                      </div>
                    ...
                    <div className="text-center p-4 sm:p-6 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300">
                      <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-r from-[#E91E63]/20 to-[#EC407A]/20 rounded-2xl flex items-center justify-center mx-auto mb-3 sm:mb-4">
                        <MapPin className="w-6 h-6 sm:w-8 sm:h-8 text-[#E91E63]" />
                      </div>
                    ...
                    <div className="text-center p-4 sm:p-6 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300">
                      <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-r from-[#E91E63]/20 to-[#EC407A]/20 rounded-2xl flex items-center justify-center mx-auto mb-3 sm:mb-4">
                        <Camera className="w-6 h-6 sm:w-8 sm:h-8 text-[#E91E63]" />
                      </div>
                    ...
                    <div className="text-center p-4 sm:p-6 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300">
                      <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-r from-[#E91E63]/20 to-[#EC407A]/20 rounded-2xl flex items-center justify-center mx-auto mb-3 sm:mb-4">
                        <MessageCircle className="w-6 h-6 sm:w-8 sm:h-8 text-[#E91E63]" />
                      </div>
                  ...
                  <div className="text-center mb-8 sm:mb-12">
                      ...
                      <div className="testimonial-card bg-white rounded-xl shadow-lg p-4 sm:p-5 flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0 text-left">
                          <div className="mb-2">
                            ...
                            <p className="text-xs sm:text-sm text-[#E91E63] font-medium">✓ Verified User</p>
                          </div>
                          <div className="mb-3">
                            <svg
                      ...
                      <div className="testimonial-card bg-white rounded-xl shadow-lg p-4 sm:p-5 flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0 text-left">
                          <div className="mb-2">
                            ...
                            <p className="text-xs sm:text-sm text-[#E91E63] font-medium">
                    ...
                    <Button
  onClick={() => setCurrentStep("form")}
  className="bg-gradient-to-r from-[#E91E63] to-[#EC407A] hover:from-[#E91E63] hover:to-[#EC407A] text-white font-bold py-3 sm:py-4 px-4 sm:px-6 text-sm sm:text-base md:text-lg rounded-2xl shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 w-full max-w-sm mx-auto flex items-center justify-center text-center overflow-hidden"
>
  <span className="block text-center leading-tight px-2 break-words whitespace-normal">
    🔍 START MY ANONYMOUS INVESTIGATION
          ...
          {currentStep === "form" && (
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="min-h-screen bg-[#E91E63] relative overflow-hidden"
            >
                ...
                {[...Array(3)].map((_, index) => (
                  <div
                    ...
                    style={{
                      left: `${20 + index * 30}%`,
                      top: `${20 + index * 25}%`,
                      transform: `scale(0.2) rotate(${index * 15}deg)`,
                    }}
                  >
                    <img 
                      src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/WhatsApp%20Image%202025-07-25%20at%2000.06.01-HlLJW3PBzLGO5VgYykkYeOOA3yA4LK.jpeg" 
              ...
              <div className="relative z-10 container mx-auto px-4 py-6 sm:py-8 flex items-center justify-center min-h-screen">
                <div className="w-full max-w-lg">
                  ...
                  <div className="text-center mb-6 sm:mb-8">
                    <div className="w-16 h-16 sm:w-20 sm:h-20 bg-white rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6 shadow-2xl p-2">
                      <img 
                        src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/WhatsApp%20Image%202025-07-25%20at%2000.06.01%20%281%29-StfEy4Md5yrJy8hbDh7HiHxfkdd9eY.jpeg" 
                        alt="DeepCheck AI Logo" 
                        className="w-full h-full object-contain"
                    ...
                    <CardContent className="p-4 sm:p-8 space-y-6 sm:space-y-8">
                          ...
                          {uploadedPhoto ? (
                            <div className="relative inline-block">
                              <img
                                ...
                                alt="Uploaded"
                                className="w-24 h-24 sm:w-28 sm:h-28 rounded-2xl object-cover border-4 border-[#E91E63] shadow-lg"
                              />
                              <button
                                onClick={() => setUploadedPhoto(null)}
                                className="absolute -top-2 -right-2 w-6 h-6 bg-[#E91E63] text-white rounded-full flex items-center justify-center text-xs"
                              >
                                ×
                              </button>
                            </div>
                          ) : (
                            <div className="w-24 h-24 sm:w-28 sm:h-28 border-2 border-dashed border-gray-300 rounded-2xl flex items-center justify-center mx-auto cursor-pointer hover:border-[#E91E63] transition-colors">
                              <input
                                type="file"
                                accept="image/*"
                      ...
                      <div>
                        ...
                        <div className="flex gap-2 sm:gap-3">
                          ...
                          <Input
                            ...
                            className="flex-1 py-2 sm:py-3 px-3 sm:px-4 text-sm sm:text-base rounded-xl border-gray-300 focus:border-[#E91E63] focus:ring-[#E91E63]"
                          />
                        </div>
                        ...
                        {(profilePhoto || isLoadingPhoto) && (
                          <div className="mt-4 p-3 sm:p-4 bg-gray-50 rounded-xl">
                            <div className="flex items-center gap-3 sm:gap-4">
                              ...
                              <div className="w-3 h-3 sm:w-4 sm:h-4 bg-[#E91E63] rounded-full" />
                            </div>
                          </div>
                        )}
                      </div>
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          className="py-2 sm:py-3 px-3 sm:px-4 text-sm sm:text-base rounded-xl border-gray-300 focus:border-[#E91E63] focus:ring-[#E91E63]"
                        />
                        <p className="text-xs sm:text-sm text-gray-500 mt-2 font-medium">
                      ...
                      <Button
                        ...
                        className={`w-full py-3 sm:py-4 text-sm sm:text-base md:text-lg font-bold rounded-xl transition-all duration-300 overflow-hidden ${
                          canVerify && !isSubmittingEmail
                            ? "bg-gradient-to-r from-[#E91E63] to-[#EC407A] hover:from-[#E91E63] hover:to-[#EC407A] text-white shadow-lg hover:shadow-xl transform hover:scale-105"
          ...
          {currentStep === "verification" && (
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="min-h-screen bg-gradient-to-br from-[#1A1A2E] to-[#E91E63] flex items-center justify-center px-4 py-8"
            >
              {/* Subtle background logos */}
              <div className="absolute inset-0 opacity-3">
                {[...Array(3)].map((_, index) => (
              ...
              <div className="w-full max-w-md relative">
                <Card className="bg-white rounded-2xl shadow-2xl border-0 overflow-hidden">
                  <CardContent className="p-6 sm:p-8 text-center">
                    <div className="w-16 h-16 sm:w-20 sm:h-20 bg-white rounded-2xl flex items-center justify-center mx-auto mb-6 sm:mb-8 shadow-lg p-2">
                      <img 
                        src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/WhatsApp%20Image%202025-07-25%20at%2000.06.01%20%281%29-StfEy4Md5yrJy8hbDh7HiHxfkdd9eY.jpeg" 
                        alt="DeepCheck AI Logo" 
                        className="w-full h-full object-contain"
                    ...
                    <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
                      <div className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-gray-50 rounded-xl">
                        <div className="w-2 h-2 sm:w-3 sm:h-3 bg-[#E91E63] rounded-full animate-pulse" />
              ...
              <div className="w-full max-w-lg relative">
                <Card className="bg-white rounded-2xl shadow-2xl border-0 overflow-hidden">
                  <CardContent className="p-6 sm:p-8">
                    {/* Alert Header */}
                    <div className="text-center mb-6 sm:mb-8">
                      <div className="w-16 h-16 sm:w-20 sm:h-20 bg-white rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6 shadow-lg p-2">
                        <img 
                          src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/WhatsApp%20Image%202025-07-25%20at%2000.06.01%20%281%29-StfEy4Md5yrJy8hbDh7HiHxfkdd9eY.jpeg" 
                          alt="DeepCheck AI Logo" 
                          className="w-full h-full object-contain"
                    ...
                    {/* Alert Box */}
                    <div className="bg-gradient-to-r from-[#E91E63]/10 to-[#EC407A]/10 border-2 border-[#E91E63]/30 rounded-xl p-4 sm:p-6 mb-6 sm:mb-8">
                      <div className="flex items-center gap-3 sm:gap-4 mb-3 sm:mb-4">
                        <AlertTriangle className="w-6 h-6 sm:w-8 sm:h-8 text-[#E91E63] flex-shrink-0" />
                        <h3 className="text-lg sm:text-xl font-bold text-[#E91E63]">ACTIVE DATING PROFILES DETECTED</h3>
                      </div>
                      <p className="text-sm sm:text-base text-[#E91E63] font-medium leading-relaxed">
                    ...
                    <div className="space-y-4 sm:space-y-6 mb-6 sm:mb-8">
                      <div className="flex items-start gap-3 sm:gap-4 p-4 sm:p-5 bg-gray-50 rounded-xl">
                        <CheckCircle className="w-5 h-5 sm:w-6 sm:h-6 text-[#E91E63] flex-shrink-0 mt-1" />
                        <div>
                    ...
                    <div className="bg-gradient-to-r from-[#E91E63]/10 to-[#EC407A]/10 border-2 border-[#E91E63]/30 rounded-xl p-4 sm:p-6 mb-6 sm:mb-8">
                      <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                        <div className="w-6 h-6 sm:w-8 sm:h-8 bg-[#E91E63] rounded-full flex items-center justify-center">
                          <span className="text-white text-xs sm:text-sm font-bold">💡</span>
                        </div>
                        <h3 className="text-base sm:text-lg font-bold text-[#E91E63]">
                          What You'll See in the Full Report:
                        </h3>
                      </div>
                      <ul className="space-y-2 sm:space-y-3 text-xs sm:text-sm text-[#E91E63]">
                        <li className="flex items-center gap-2 sm:gap-3">
                          <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-[#E91E63] rounded-full flex-shrink-0" />
  ...
  className="w-full bg-gradient-to-r from-[#E91E63] to-[#EC407A] hover:from-[#E91E63] hover:to-[#EC407A] text-white font-bold py-3 sm:py-4 text-sm sm:text-base md:text-lg rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 mb-4 sm:mb-6 overflow-hidden flex items-center justify-center text-center"
>
  <span className="block text-center leading-tight px-2 break-words whitespace-normal">
    🔓 UNLOCK COMPLETE EVIDENCE – SEE EVERYTHING
              ...
              <div className="w-full max-w-md relative">
                <Card className="bg-white rounded-2xl shadow-2xl border-0 overflow-hidden">
                  <CardContent className="p-6 sm:p-8 text-center">
                    ...
                    <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
                      <div className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-[#E91E63]/10 rounded-xl">
                        <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-[#E91E63]" />
                        <span className="text-xs sm:text-sm text-gray-700 font-medium">Profile photos analyzed</span>
                      </div>
                      <div className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-[#E91E63]/10 rounded-xl">
                        <div className="w-4 h-4 sm:w-5 sm:h-5 border-2 border-[#E91E63] border-t-transparent rounded-full animate-spin" />
                        <span className="text-xs sm:text-sm text-gray-700 font-medium">
          ...
          {currentStep === "result" && (
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="min-h-screen bg-gradient-to-br from-[#1A1A2E] to-[#E91E63] px-4 py-6 sm:py-8"
            >
              {/* Subtle background logos */}
              <div className="absolute inset-0 opacity-3">
                {[...Array(3)].map((_, index) => (
              ...
              <div className="container mx-auto max-w-4xl">
                {/* Alert Banners */}
                <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
                  <div className="bg-gradient-to-r from-[#E91E63] to-[#EC407A] text-white p-3 sm:p-4 rounded-xl shadow-lg">
                    <div className="flex items-center gap-2 sm:gap-3">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 mb-6 sm:mb-8">
                  <div className="bg-white rounded-xl p-3 sm:p-4 text-center shadow-lg">
                    <div className="text-xl sm:text-2xl font-bold text-[#E91E63] mb-1">6</div>
                    <div className="text-xs sm:text-sm text-gray-600 font-medium">MATCHES (7 DAYS)</div>
                  </div>
                  <div className="bg-white rounded-xl p-3 sm:p-4 text-center shadow-lg">
                    <div className="text-xl sm:text-2xl font-bold text-[#E91E63] mb-1">30</div>
                    <div className="text-xs sm:text-sm text-gray-600 font-medium">LIKES (7 DAYS)</div>
                  </div>
                  <div className="bg-white rounded-xl p-3 sm:p-4 text-center shadow-lg">
                    <div className="text-xl sm:text-2xl font-bold text-[#E91E63] mb-1">4</div>
                    <div className="text-xs sm:text-sm text-gray-600 font-medium">ACTIVE CHATS</div>
                  </div>
                  <div className="bg-white rounded-xl p-3 sm:p-4 text-center shadow-lg">
                    <div className="text-xl sm:text-2xl font-bold text-[#E91E63] mb-1">18h</div>
                    ...
                    <div className="space-y-3 sm:space-y-4">
                      {generateFakeProfiles().map((profile, index) => (
                        <div key={index} className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-gray-50 rounded-xl">
                          <div className="w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-r from-[#E91E63]/20 to-[#EC407A]/20 rounded-xl flex items-center justify-center">
                            <User className="w-6 h-6 sm:w-8 sm:h-8 text-[#E91E63]" />
                          </div>
                          <div className="flex-1">
                        ...
                        {blockedImages.map((_, index) => (
                          <button
                            ...
                            className={`w-2 h-2 sm:w-3 sm:h-3 rounded-full transition-colors ${
                              index === currentSlide ? "bg-[#E91E63]" : "bg-gray-300"
                            }`}
                          />
                        ))}
                      </div>
                ...
                <Card className="bg-white rounded-2xl shadow-lg border-0">
                  <CardContent className="p-4 sm:p-6 text-center">
                    <div className="mb-4 sm:mb-6">
                      <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-r from-[#E91E63] to-[#EC407A] rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6 shadow-lg">
                    ...
                    <div className="bg-gradient-to-r from-[#E91E63] to-[#EC407A] text-white p-4 sm:p-6 rounded-xl shadow-lg mb-4 sm:mb-6">
                    ...
                    <Button
                      ...
                      className="w-full bg-gradient-to-r from-[#E91E63] to-[#EC407A] hover:from-[#E91E63] hover:to-[#EC407A] text-white font-bold py-3 sm:py-4 text-sm sm:text-base md:text-lg rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 mb-4 sm:mb-6 overflow-hidden"
                    >
                ...
                <Card className="bg-white rounded-2xl shadow-2xl border-0">
                  <CardContent className="p-6 sm:p-8 text-center">
                    ...
                    <div className="mb-6 sm:mb-8">
                      ...
                      <div className="bg-gradient-to-r from-[#E91E63]/10 to-[#EC407A]/10 border-2 border-[#E91E63]/30 rounded-xl p-4 sm:p-6">
                        <p className="text-sm sm:text-base text-[#E91E63] font-semibold leading-relaxed">
                    ...
                    <div className="mb-6 sm:mb-8">
                      <div className="flex items-center justify-center gap-4 sm:gap-6 mb-4 sm:mb-6">
                        ...
                        <div className="text-4xl sm:text-5xl font-bold text-[#E91E63]">$17.00</div>
                      </div>
                      <div className="inline-flex items-center gap-2 bg-gradient-to-r from-[#E91E63] to-[#EC407A] text-white px-4 sm:px-6 py-2 sm:py-3 rounded-full text-sm sm:text-base font-bold mb-4">
                        🔥 62% OFF - LIMITED TIME
                      </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mb-6 sm:mb-8">
                      <div className="flex items-center gap-2 sm:gap-3 p-3 sm:p-4 bg-gray-50 rounded-xl">
                        <Lock className="w-4 h-4 sm:w-5 sm:h-5 text-[#E91E63]" />
                        <span className="text-xs sm:text-sm font-medium text-gray-700">100% Anonymous</span>
                      </div>
                      <div className="flex items-center gap-2 sm:gap-3 p-3 sm:p-4 bg-gray-50 rounded-xl">
                        <Shield className="w-4 h-4 sm:w-5 sm:h-5 text-[#E91E63]" />
                    ...
                    <div className="bg-gradient-to-r from-[#E91E63]/10 to-[#EC407A]/10 border-2 border-[#E91E63]/30 rounded-xl p-4 sm:p-6 mb-6 sm:mb-8">
                      <div className="flex items-center justify-center gap-2 sm:gap-3 mb-2">
                        <AlertTriangle className="w-5 h-5 sm:w-6 sm:h-6 text-[#E91E63]" />
                        <span className="font-bold text-[#E91E63] text-sm sm:text-base">OFFER EXPIRES IN:</span>
                      </div>
                      <div className="text-2xl sm:text-3xl font-bold text-[#E91E63] mb-2">{formatTime(timeLeft)}</div>
                      <p className="text-xs sm:text-sm text-[#E91E63]">
                    ...
                    <Button
                      ...
                      className="w-full bg-gradient-to-r from-[#E91E63] to-[#EC407A] hover:from-[#E91E63] hover:to-[#EC407A] text-white font-bold py-4 sm:py-6 text-sm sm:text-base md:text-lg rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 mb-4 sm:mb-6 overflow-hidden"
                    >
                      <span className="block text-center leading-tight px-2">
                    ...
                    {/* Final Reassurance */}
                    <div className="bg-[#E91E63]/10 border border-[#E91E63]/30 rounded-xl p-4 sm:p-6 mb-4 sm:mb-6">
                      <p className="text-sm sm:text-base text-[#E91E63] font-medium leading-relaxed">
